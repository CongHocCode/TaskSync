...
<aside class="app-sidebar">
    ...
    <a href="<?= BASE_URL ?>/task/create" class="app-btn app-btn-create-issue">
    ...
    <div class="sidebar-section">
        ...
        <div class="sidebar-project">
            ...
            <nav class="sidebar-nav sidebar-project-nav">
                <a href="<?= BASE_URL ?>/project/kanban/web" class="sidebar-link">
                    <i class="bi bi-kanban-fill"></i>
                    <span>Bảng Kanban</span>
                </a>
                <a href="<?= BASE_URL ?>/project/list/web" class="sidebar-link">
                    <i class="bi bi-list-ul"></i>
                    <span>Danh sách</span>
                </a>
                <a href="<?= BASE_URL ?>/project/members/web" class="sidebar-link">
                    <i class="bi bi-people-fill"></i>
                    <span>Thành viên Dự án</span>
                </a>
                <a href="<?= BASE_URL ?>/project/settings/web" class="sidebar-link">
