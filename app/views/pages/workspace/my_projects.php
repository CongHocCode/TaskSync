                ...
                <div class="card h-100 shadow-sm border border-light-subtle rounded-3" style="background-color: #ffffff;">
                    <div class="card-body p-4 d-flex flex-column justify-content-between">
                        ...
                        <div>
                            ...
                            <h5 class="card-title fw-bold mb-2 truncate-title" style="color: #111827; font-size: 1.05rem;">
                                <?= htmlspecialchars($project['name']) ?>
                            </h5>

                            <p class="card-text text-muted mb-4 truncate-description" style="font-size: 0.85rem;">
